...
// Heading
$_['heading_title'] = 'Payfast Aggregation';

// Text
$_['text_extension'] = 'Extensions';
$_['text_success']   = 'Success: You have modified your Payfast Aggregation configuration details!';
$_['text_payfast']   = '<a target="_BLANK" href="https://payfast.io"><img
                                        src="/extension/payfast/admin/view/image/payment/payfast.svg"
                                        alt="Payfast" border="0" height="40px" /></a>';
$_['text_debug']     = 'Debug';
...
$_['help_payfast_passphrase']   = 'Only insert a value for passphrase if you have
                                        set a passphrase in your Payfast Aggregation account!';
$_['help_payfast_merchant_id']  = 'Use Sandbox credentials when Sandbox Mode is set to Yes,
                                        else use your Payfast Aggregation account credentials';
...
// Error
$_['error_permission']           = 'Warning: You do not have permission to modify the Payfast Aggregation payment!';
